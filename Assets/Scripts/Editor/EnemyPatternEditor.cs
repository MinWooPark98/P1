                        ...
                        case "buffList":
                            {
                                ...
                                {
                                    enemyPattern.AddBuff(new BuffData(BUFF_TARGET.Player, BUFF_TYPE.Artifact, -1, false, false));
                                    property.isExpanded = true;
                                }
                                if (GUILayout.Button("Add BuffEnemy", optionButtons))
                                {
                                    enemyPattern.AddBuff(new BuffData(BUFF_TARGET.Enemy, BUFF_TYPE.Artifact, -1, false, false));
                                    property.isExpanded = true;
                                }
