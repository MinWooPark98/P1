...
public class ItemCardActionEditor : MonoBehaviour
{
    private Dictionary<string, ItemCardActionEditorElement> dictField = new Dictionary<string, ItemCardActionEditorElement>();
    [SerializeField]
    private RectTransform parent = null;
    [SerializeField]
    private ItemCardActionEditorElement prefabElement = null;
    [SerializeField]
    ...
    public void Set(CardAction.CardAction _action)
    {
        ...
        foreach (FieldInfo field in fields)
        {
            ...
            ItemCardActionEditorElement item = Instantiate(prefabElement, parent);
